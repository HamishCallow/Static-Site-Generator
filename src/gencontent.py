...
def generate_pages_recursive(dir_path_content, template_file, dest_dir_path):
    for entry_name in os.listdir(dir_path_content):
        ...
        if os.path.isfile(src_path) and src_path.endswith(".md"):
            generate_page(src_path, template_file, output_html_path)
        elif os.path.isdir(src_path):
            os.makedirs(dest_dir_for_entry, exist_ok=True)
            generate_pages_recursive(src_path, template_file, dest_dir_for_entry)
